...
class MusicItem extends Component {
  ...
  render() {
    return (
      <div className="music">
        <div disabled={this.state.isButtonDisabled} className="thumbs">
          <FontAwesomeIcon
            className="like-icon"
            onClick={() => this.likesHandler()}
            icon={faThumbsUp}
          />
          <div className="like-button">{this.state.likes}</div>
        </div>

        <img className="music-image" src={this.props.song.img} />
